...
} from '@/modules/media/application/constants/media-upload.constant';
...
export class MediaUploadService {
    ...
    private assertUploadPolicy(dto: CreatePresignedUploadDto): number {
        const isImagePurpose = (
            MEDIA_IMAGE_UPLOAD_PURPOSES as readonly string[]
        ).includes(dto.purpose);
        const isVideoPurpose = (
            MEDIA_VIDEO_UPLOAD_PURPOSES as readonly string[]
        ).includes(dto.purpose);
