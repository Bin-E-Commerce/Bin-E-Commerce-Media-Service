...
import { PRODUCT_MEDIA_CLEANUP_PURPOSES } from '@/modules/media/application/constants/media-upload.constant';
import type { ProductMediaCleanupPurpose } from '@/modules/media/application/types/media-upload.type';
